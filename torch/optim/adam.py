...
class Adam(Optimizer):
    ...
    Args:
        ...
        differentiable (bool, optional): whether autograd should occur through the optimizer step in training
            otherwise, the step() function runs in a torch.no_grad() context,
            Setting to True can impair performance, so leave it False if you don't intend to run autograd through this instance (default: False)
